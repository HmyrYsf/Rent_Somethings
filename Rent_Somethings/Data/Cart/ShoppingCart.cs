...
namespace Rent_Somethings.Data.Cart
{
    public class ShoppingCart
    {
        ...
        public double GetShoppingCartTotal() => _context.ShoppingCartItems.Where(n => n.ShoppingCartId == ShoppingCartId).Select(n => n.Product.Price * n.Amount * (n.Product.EndDate.DayOfYear - n.Product.StartDate.DayOfYear)).Sum();
